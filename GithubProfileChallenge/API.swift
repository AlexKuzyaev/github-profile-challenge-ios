    ...
    public struct User: GraphQLSelectionSet {
      ...
      public static var selections: [GraphQLSelection] {
        return [
          ...
          GraphQLField("pinnedItems", arguments: ["types": ["REPOSITORY"], "first": 3], type: .nonNull(.object(PinnedItem.selections))),
          GraphQLField("topRepositories", arguments: ["orderBy": ["field": "UPDATED_AT", "direction": "DESC"], "first": 10], type: .nonNull(.object(TopRepository.selections))),
      ...
      public init(name: String? = nil, login: String, avatarUrl: String, email: String, followers: Follower, following: Following, pinnedItems: PinnedItem, topRepositories: TopRepository, starredRepositories: StarredRepository) {
        self.init(unsafeResultMap: ["__typename": "User", "name": name, "login": login, "avatarUrl": avatarUrl, "email": email, "followers": followers.resultMap, "following": following.resultMap, "pinnedItems": pinnedItems.resultMap, "topRepositories": topRepositories.resultMap, "starredRepositories": starredRepositories.resultMap])
      }
...
public struct RepositoryDetail: GraphQLFragment {
  ...
  public init(id: GraphQLID, owner: Owner, name: String, description: String? = nil, stargazerCount: Int, primaryLanguage: PrimaryLanguage? = nil) {
    self.init(unsafeResultMap: ["__typename": "Repository", "id": id, "owner": owner.resultMap, "name": name, "description": description, "stargazerCount": stargazerCount, "primaryLanguage": primaryLanguage.flatMap { (value: PrimaryLanguage) -> ResultMap in value.resultMap }])
  }
